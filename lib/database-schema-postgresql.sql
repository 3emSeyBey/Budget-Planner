-- Budget Planner Database Schema for PostgreSQL (Neon, Supabase)
-- Compatible with Neon, Supabase, and other PostgreSQL services
...
CREATE TRIGGER update_weekly_budgets_updated_at BEFORE UPDATE ON weekly_budgets FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
